...
class CartModel extends Model
{
    ...
    {
        return $this->select('cart.*, products.name as product_name, products.price, products.unit, products.image_url, products.stock_quantity, products.farmer_id, users.name as farmer_name, users.location')
