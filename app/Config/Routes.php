...
$routes->group('admin', ['filter' => 'auth:admin'], function($routes) {
    ...
    $routes->post('users/whitelist', 'Admin::updateWhitelist');
    ...
    $routes->post('moderation/restore', 'Admin::restoreSuspendedContent');
    $routes->post('moderation/block-user', 'Admin::blockUserFromModeration');
