        ...
        <div class="flex flex-col md:flex-row md:items-start md:justify-between gap-4">
            <div>
                ...
                <p class="text-sm text-gray-600 mt-1">
                    When enabled, only whitelisted emails can access the system. All non-admin accounts that are not whitelisted will be disabled automatically.
                </p>
            </div>
        </div>

        <form action="/admin/users/whitelist" method="POST" class="mt-4">
            <?= csrf_field() ?>
            <div class="flex items-center justify-between gap-4 flex-wrap">
                <label class="inline-flex items-center gap-2">
                    ...
                    >
                    <span class="text-sm font-semibold text-gray-900">Enable whitelist</span>
                </label>
            ...
            <div class="mt-4">
                <label for="whitelisted_emails" class="block text-sm font-medium text-gray-700 mb-1">Whitelisted emails</label>
                <textarea
                ...
                <p class="mt-1 text-xs text-gray-500">Only valid emails are saved.</p>
            </div>
        </form>
    </div>
