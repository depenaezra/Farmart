...
<div class="container mx-auto px-4 py-8">
    ...
    <div class="bg-white rounded-xl shadow-md border border-gray-200">
        ...
        <div id="security-tab" class="settings-content p-6 hidden">
            ...
            <form class="space-y-6" action="/admin/settings" method="POST">
                <?= csrf_field() ?>
                <div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="mt-6 p-4 rounded-lg border border-emerald-200 bg-emerald-50/60">
                        <div class="flex items-start justify-between gap-4">
                            <div>
                                <p class="text-sm font-semibold text-emerald-900">Email whitelist</p>
                                <p class="text-sm text-emerald-800 mt-1">
                                    When enabled, only emails listed below can access the system.
                                </p>
                            </div>
                            <label class="inline-flex items-center gap-2">
                                <input
                                    ...
                                    value="1"
                                    <?= !empty($email_whitelist_enabled) ? 'checked' : '' ?>
                                    class="h-4 w-4 text-primary focus:ring-primary border-gray-300 rounded"
                                >
                                <span class="text-sm font-semibold text-emerald-900">Enable</span>
                            </label>
                        </div>

                        <div class="mt-4">
                            <label for="whitelisted_emails" class="block text-sm font-medium text-gray-700 mb-2">Allowed emails</label>
                            <textarea
                            ...
                            ><?= esc(!empty($whitelisted_emails) ? implode("\n", $whitelisted_emails) : '') ?></textarea>
                            <p class="mt-1 text-sm text-gray-500">Tip: paste a list; invalid entries will be ignored.</p>
                        </div>
                    </div>
