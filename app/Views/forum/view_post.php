            ...
            <div class="p-6">
                ...
                <div class="flex items-center gap-4 pt-4 border-t border-gray-200">
                    ...
                    <?php if (session()->get('user_id') && (session()->get('user_id') == $post['user_id'] || session()->get('user_role') == 'admin')): ?>
                        <form action="/forum/post/<?= $post['id'] ?>/delete" method="POST" class="inline ml-auto swal-confirm-form" data-confirm-title="Delete this forum post?" data-confirm="All comments will be removed. This cannot be undone." data-confirm-ok="Yes, delete post" data-confirm-danger data-confirm-icon="warning">
                            <?= csrf_field() ?>
