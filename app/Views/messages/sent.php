                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="ml-4 flex gap-2">
                                ...
                                <form action="/messages/delete/<?= $message['id'] ?>" method="POST" class="inline swal-confirm-form" data-confirm-title="Delete from sent?" data-confirm="Removes this copy from your sent folder permanently." data-confirm-ok="Delete" data-confirm-danger data-confirm-icon="warning">
                                    <?= csrf_field() ?>
