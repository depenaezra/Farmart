...
<div class="container mx-auto px-4 pt-4 py-2 max-w-6xl">
    <div class="w-full">
        ...
        <div class="flex flex-col md:flex-row gap-6 max-w-6xl mx-auto md:items-start justify-center min-h-screen">
            <!-- Left Side: Admin Profile Card and Buttons -->
            <div class="flex-1 flex flex-col space-y-4 min-w-0 w-full md:max-w-md">
        ...
        <div class="flex flex-col md:flex-row gap-6 min-h-[80vh] w-full max-w-6xl mx-auto md:items-start">
            <!-- Profile Card + stats column -->
            <div class="flex-1 flex flex-col md:flex-row gap-4 min-w-0 w-full md:max-w-none">
                <div class="w-full md:flex-1 md:min-w-0 bg-gradient-to-br from-primary to-primary-hover rounded-xl shadow-lg border border-gray-100 p-4 transform hover:scale-105 transition-all duration-300 self-stretch">
                    <div class="text-center mb-4">
                        <div class="w-16 h-16 rounded-full bg-white/20 backdrop-blur-sm border-2 border-white/30 flex items-center justify-center mx-auto mb-3 shadow-md">
                ...
                <!-- Quick Stats -->
                <div class="w-full md:w-56 md:flex-shrink-0 bg-white rounded-lg shadow-md border border-gray-100 p-3 self-stretch">
        ...
        <?php endif; ?>
            ...
            <div class="flex-1 flex flex-col min-w-0">
                <div class="bg-white rounded-lg shadow-md border border-gray-100 p-4 hover:shadow-lg transition-shadow duration-300 flex-1 flex flex-col min-h-[400px] min-w-0">
