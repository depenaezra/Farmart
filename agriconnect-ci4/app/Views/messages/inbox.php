...
<div class="container mx-auto px-4 py-8">
    ...
    <?php if (empty($messages)): ?>
        <div class="text-center py-20">
            ...
            <p class="text-xl text-gray-600">No messages</p>
                    ...
                    <div class="p-6 hover:bg-gray-50 transition-colors <?= !$message['is_read'] ? 'bg-mint-light/60 border-l-4 border-l-primary' : '' ?>">
                        <div class="flex items-start justify-between">
                            ...
                            <div class="ml-4 flex gap-2">
                                ...
                                <form action="/messages/delete/<?= $message['id'] ?>" method="POST" class="inline swal-confirm-form" data-confirm-title="Delete this message?" data-confirm="It will be removed from your inbox permanently." data-confirm-ok="Delete" data-confirm-danger data-confirm-icon="warning">
                                    <?= csrf_field() ?>
