...
<div class="container mx-auto px-4 py-8">
    <div class="mb-8">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-3xl font-bold text-gray-900 mb-2">Create Announcement</h1>
                <p class="text-gray-600">Create a new system-wide announcement</p>
            </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="category" name="category"
                            ...
                            <option value="weather" <?= old('category') === 'weather' ? 'selected' : '' ?>>Weather</option>
                            <option value="government" <?= old('category') === 'government' ? 'selected' : '' ?>>Government</option>
                            <option value="market" <?= old('category') === 'market' ? 'selected' : '' ?>>Market</option>
