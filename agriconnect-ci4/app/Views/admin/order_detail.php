...
<div class="container mx-auto px-4 py-8">
    <div class="max-w-4xl mx-auto">
        <!-- Back Button -->
        <a href="/admin/orders" class="inline-flex items-center text-primary hover:text-primary-hover mb-6">
            ...
            <div class="flex items-center justify-between mb-4">
                <div>
                    <h1 class="text-2xl font-bold text-gray-900 mb-2">
                        Order #<?= esc($order['order_number'] ?? '#' . $order['id']) ?>
                    </h1>
                ...
                <div class="bg-white rounded-xl shadow-md border border-gray-200 p-6 sticky top-4">
                    ...
                    <div class="mb-6 pb-6 border-b border-gray-200">
                        ...
                        <form action="/admin/orders/<?= $order['id'] ?>/update-status" method="POST">
                            ...
                            <button type="submit" class="w-full bg-primary text-white py-2 px-4 rounded-lg hover:bg-primary-hover font-semibold transition-colors">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="space-y-3 text-sm">
                            ...
                            <?php if ($order['status'] !== 'pending' && !empty($order['updated_at'])): ?>
                                <div class="flex items-start">
