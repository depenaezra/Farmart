...
const mockOrders = [
  {
    ...
    address: "Brgy. Poblacion, Tuy, Batangas"
  },
  {
    id: "ORD-002",
    buyer: "Juan Cruz",
    ...
    <div className="py-8 bg-neutral-50 min-h-screen">
      <div className="container max-w-5xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-neutral-600">View and manage your incoming orders</p>
        </div>
